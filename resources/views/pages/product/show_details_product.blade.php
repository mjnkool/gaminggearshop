		...
		<div id="similar-product" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<div class="item active">
					<a href=""><img src="{{URL::to('public/frontend/imgs/similar1.jpg')}}" alt=""></a>
					<a href=""><img src="{{URL::to('public/frontend/imgs/similar2.jpg')}}" alt=""></a>
					<a href=""><img src="{{URL::to('public/frontend/imgs/similar3.jpg')}}" alt=""></a>
				</div>
