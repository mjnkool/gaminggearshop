            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="public/upload/product/{{($pro -> product_image)}}" height="100" weight="100"></td>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Bạn có muốn xóa chắc chắn chứ?')" href="{{URL::to('/delete-product/'.$pro->product_id)}}" class="active styling-edit" ui-toggle-class="">  
